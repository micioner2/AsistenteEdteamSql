...
SET DATEFORMAT DMY  ---- ASIGANR FORMATO DE LA FECHA DIA, MES Y AÑO
GO
...
---CREARÁ LAS ESTRUCTURAS EN EL GRUPO DE ARCHIVOS PRIMARIOS.
ON PRIMARY  
	(
		NAME='bdzapateriaedteam_dat',  ------ NOMBRE DEL ARCHIVO CON EXTENSIÓN MDF (ARCHIVOS DE REGISTROS DE BD)
		FILENAME ='c:\edteam\bdzapateriaedteamdat.mdf', --- COLOCAR EL ARCHIVO CON EXTENSION MDF EN EL DIRECTORIO ESPECIFICADO
		SIZE = 10,       ------ DEFINIR EL TAMAÑO DEL ARCHIVO
		MAXSIZE = 50,    ------ DEFINIR EL TAMAÑO MAXIMO DE CRECIMIENTO DEL ARCHIVO
		FILEGROWTH = 5	 ------ DEFINIR CUANTO DEBE DE CRECER EL ARCHIVO, CADA VEZ QUE NECESITA CRECER
	)
LOG ON
	(
		NAME ='bdzapateriaedteam_log', ------ NOMBRE DEL ARCHIVO CON EXTENSIÓN LOG (ARCHIVOS DE REGISTROS DE BD)
		FILENAME = 'c:\edteam\bdzapateriaedteamlog.ldf', --- COLOCAR EL ARVHIVO CON EXTENSION LDF EN EL DIRECTORIO ESPECIFICADO
		SIZE = 5MB, ------ DEFINIR EL TAMAÑO DEL ARCHIVO
		MAXSIZE = 25, ------ DEFINIR EL TAMAÑO MAXIMO DE CRECIMIENTO DEL ARCHIVO
		FILEGROWTH = 5MB ------ DEFINIR CUANTO DEBE DE CRECER EL ARCHIVO, CADA VEZ QUE NECESITA CRECER
	)
	
GO

USE bdzapateriaedteam					---- USAR LA TABLA ESPECIFICADA
...
----- ALTERAR LA TABLA CLIENTE Y RESTRINGIR A LA TABLA CLIENTE A SU CAMPO identificacion, QUE SU CAMPO SEA ÚNICO.
